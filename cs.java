...
public class cs{
	public static void main(String[] args) {
        ...
        while(choice.equalsIgnoreCase("y")) {  
	        ...
	        switch(options){
	        	case "1": try { AddRecord(); } catch(IOException e) { e.printStackTrace();} break;
	        	case "2": try { ViewAllRecord(); } catch(IOException e) { e.printStackTrace();} break;
	        	case "3": try { SearchRecordbyNoOrName(); } catch(IOException e) { e.printStackTrace();} break;
	        	case "4": try { updateRecordbyNO(); } catch(IOException e) { e.printStackTrace();} break;
	        	case "5": try { DeleteRecordByNO(); } catch(IOException e) { e.printStackTrace();} break;
	        	case "6": clearscreen();
	        			System.out.print("\n\t\t\t\t--------------Goodbye, Thankyou! :) --------------\n");
	        			System.exit(0); break;
	...
	public static void footer(){
		System.out.println("  |____________________________________________*Nothing Follows*____________________________________________________|");
	}
	...
	public static void updateRecordbyNO() throws IOException {
		try {
			clearscreen();
			ViewAllRecord();
			String newStudentNo = "", newFname = "", newMInitial = "", newLname = "", newAge = "", newGender = "", newYear ="", newCourse ="", newCampus ="";
				...
				while( (record2 = br2.readLine() ) != null ) {  
    				...
    				|| data[3].toString().equals(student_info)) {
						bw.write(newStudentNo+":::"+newFname+":::"+newMInitial+":::"+newLname
								+":::"+newAge+":::"+newGender+":::"+newYear+":::"+newCourse+":::"+newCampus);
					} else {
						bw.write(record2);	
					}    			
					bw.flush();
